...
const BoardMembersList = () => {
  ...
  const [isLoadingDeleteMember, setIsLoadingDeleteMember] = useState(null)
  ...
  const handleRemoveMember = (memberId, memberName) => {
    confirm({
      ...
      try {
        setIsLoadingDeleteMember(memberId)
              ...
              <Box
                ...
                {canRemove && (
                  <Tooltip title="Remove member">
                    <IconButton
                      loading={isLoadingDeleteMember === user._id}
                      size="small"
                      color="error"
